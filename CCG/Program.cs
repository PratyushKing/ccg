...
namespace CCG //change this to your namespace
{
    public class ccg
    {
        ...
        public void Run()
        {
            ...
            foreach (var line in file)
            {
                ...
                {
                    //please change data.currentDir to your current directory path and uncomment
            ...
            redraw:
                ...
                if (nextPage == null)
                {
                    Console.ResetColor();
                    Console.Clear();
                    //File.WriteAllText(data.currentDir + "output.txt", input); //replace data.currentDir with your current directory
                    return;
                }
                else if (File.Exists(nextPage))
                {
